...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const i18n = {
    zh: {
      ...
      'nav.technology': "\u6838\u5fc3\u6280\u8853",
      'news.eyebrow': "\u6700\u65b0\u6d88\u606f",
      'news.item1.date': "東京，日本－2026年7月",
      'news.item1.location': "東京，日本",
      'news.item1.desc': "NextDrive位於熊本的日本首座表前儲能案場正式併網，啟動電力交易服務。",
      'news.item1.tag': "新聞發布",
      'news.item1.title': "NextDrive首座日本表前儲能併網上線",
      'news.item1.content': "<p>NextDrive 聯齊科技宣布，位於日本九州熊本縣山鹿市的表前儲能案場已完成併網，並自今年7月起同步取得 JEPX（日本電力交易所）現貨市場與 EPRX 電力調整力市場的交易資格，成為 NextDrive 在日本市場的首座表前（Front-of-the-Meter）儲能案場，標誌著公司電力聚合業務正式跨入電網端大型儲能資產的開發與交易。</p><p><strong>首座表前儲能案場 於九州電力區域完成併網</strong></p><p>本案場座落於熊本縣山鹿市，交流併網容量達 1.999MW，直流儲能容量達 8.128MWh，採用 TMEIC 電力轉換系統（PCS）搭配 CATL 電芯，經九州電力核准併入區域電網。案場自申請併網、興建到完成商轉，歷時逾一年半的開發流程，展現 NextDrive 在日本市場土地取得、電網申設與工程執行的完整專案能力。</p><p><strong>跨足 JEPX 與 EPRX 市場 拓展電力交易版圖</strong></p><p>隨著案場今年 4 月起投入 JEPX 現貨市場交易，並於 7 月同步取得 EPRX 調整力市場資格，NextDrive 得以透過 IoE 平台的預測型 AI 調度能力，依即時電價與電網需求動態調整儲能案場的充放電策略，同時參與能量與調整力雙市場，提升案場整體收益表現。此案場的上線，也象徵 NextDrive 的日本業務版圖，正式由既有的表後（Behind-the-Meter）能源管理，延伸至表前電網級儲能與市場交易，完善公司在日本電力聚合價值鏈的佈局。</p><p>展望未來，隨著日本電力市場持續開放、表前儲能案場的併網申請量能穩定成長，NextDrive 將持續複製此案場的開發與交易模式，於九州及其他區域佈局更多表前儲能資產，並以 IoE 平台為核心，串連表前、表後與分散式能源資源，協助日本電力系統邁向更具韌性與市場效率的能源轉型。</p>",
    ...
    en: {
      'news.item1.date': "Tokyo, Japan – July 2026",
      'news.item1.location': "Tokyo, Japan",
      'news.item1.desc': "NextDrive's first Japan front-of-meter BESS in Kumamoto is now connected and trading.",
      'news.item1.tag': "Press Release",
      'news.item1.title': "NextDrive's First Japan FTM BESS Goes Live for Trading",
      'news.item1.content': "<p>NextDrive announces that its front-of-the-meter (FTM) battery energy storage system (BESS) project in Yamaga City, Kumamoto Prefecture, Kyushu, Japan, has been successfully connected to the grid, and as of this July has simultaneously qualified to trade in both the JEPX (Japan Electric Power Exchange) spot market and the EPRX balancing (reserve) market. This marks NextDrive's first front-of-the-meter storage project in Japan, and signals the company's expansion of its energy aggregation business into the development and trading of grid-scale storage assets.</p><p><strong>First Front-of-the-Meter BESS Grid-Connected in the Kyushu Region</strong></p><p>Located in Yamaga City, Kumamoto Prefecture, the project has an AC grid-connection capacity of 1.999MW and a DC storage capacity of 8.128MWh, built using a TMEIC power conversion system (PCS) paired with CATL battery cells, and approved for interconnection by Kyushu Electric Power. From the interconnection application through construction to commercial operation, the project took more than a year and a half to develop, demonstrating NextDrive's end-to-end project capabilities in the Japanese market — from land acquisition and grid application to construction execution.</p><p><strong>Expanding into JEPX and EPRX Markets to Grow Its Electricity Trading Business</strong></p><p>Since entering JEPX spot market trading in April this year and qualifying for the EPRX balancing market in July, NextDrive is using predictive AI dispatch on its IoE platform to dynamically adjust the project's charge-discharge strategy based on real-time electricity prices and grid needs, participating in both the energy and balancing markets to improve the project's overall returns. The launch of this project also marks the expansion of NextDrive's business in Japan from its existing behind-the-meter (BTM) energy management into front-of-the-meter, grid-scale storage and market trading, rounding out the company's position across the energy aggregation value chain in Japan.</p><p>Looking ahead, as Japan's electricity market continues to open and interconnection applications for front-of-the-meter storage projects steadily increase, NextDrive will continue to replicate this project's development and trading model, expanding its front-of-the-meter storage assets in Kyushu and other regions. Built around its IoE platform, the company will continue to connect front-of-the-meter, behind-the-meter, and distributed energy resources, helping Japan's power system move toward a more resilient and market-efficient energy transition.</p>",
    ...
    ja: {
      'news.item1.date': "東京、日本－2026年7月",
      'news.item1.location': "東京、日本",
      'news.item1.desc': "NextDriveの日本初表前蓄電所（熊本県）が系統連系を完了し、電力取引を開始した。",
      'news.item1.tag': "プレスリリース",
      'news.item1.title': "NextDrive、日本初表前蓄電所が稼働開始",
      'news.item1.content': "<p>NextDrive（聯齊科技）は、日本・九州・熊本県山鹿市に位置する表前（メーター前）蓄電池（BESS）案件が系統連系を完了し、本年7月よりJEPX（日本卸電力取引所）のスポット市場およびEPRX調整力市場の双方で取引資格を取得したことを発表する。本案件はNextDriveにとって日本国内初の表前蓄電所となり、同社のエネルギーアグリゲーション事業が系統側の大規模蓄電資産の開発・取引へと拡大したことを示すものである。</p><p><strong>九州エリアにて表前蓄電所が系統連系を完了</strong></p><p>本案件は熊本県山鹿市に位置し、交流系統連系容量は1.999MW、直流蓄電容量は8.128MWhに達する。TMEIC製の電力変換システム（PCS）とCATL製電池セルを組み合わせ、九州電力の承認のもと系統への連系を実現した。系統連系申請から建設、商業運転開始に至るまで1年半以上を要しており、土地取得、系統連系申請、工事施工に至るNextDriveの日本市場における一貫したプロジェクト遂行力を示している。</p><p><strong>JEPXおよびEPRX市場への参入により電力取引事業を拡大</strong></p><p>本年4月よりJEPXスポット市場での取引を開始し、7月にはEPRX調整力市場の取引資格も取得したことにより、NextDriveはIoEプラットフォーム上の予測型AI調整機能を活用し、リアルタイムの電力価格や系統ニーズに応じて充放電戦略を動的に調整、エネルギー市場と調整力市場の双方に参加することで案件全体の収益性向上を図る。本案件の稼働開始は、NextDriveの日本事業がこれまでのメーター後（表後）エネルギー管理から、メーター前（表前）の系統規模蓄電および市場取引へと拡大したことも意味し、日本におけるエネルギーアグリゲーション事業のバリューチェーン強化につながっている。</p><p>今後、日本の電力市場の自由化がさらに進み、表前蓄電案件の系統連系申請が着実に増加する中、NextDriveは本案件の開発・取引モデルを継続的に展開し、九州をはじめとする各地域で表前蓄電資産の拡大を図る。引き続きIoEプラットフォームを核として、表前・表後および分散型エネルギーリソースを統合し、日本の電力システムがより強靭かつ市場効率性の高いエネルギー転換を実現できるよう支援していく。</p>",
